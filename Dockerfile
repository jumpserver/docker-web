...
RUN set -ex \
    ...
    && wget -qO  JumpServer-Client-Installer.dmg ${DOWNLOAD_URL}/public/JumpServer-Client-Installer-${Client_VERSION}.dmg \
...
RUN set -ex \
    ...
    && wget -qO chromedriver_win32.zip ${DOWNLOAD_URL}/files/chromedriver/${CHROMEDRIVER_VERSION}/chromedriver_win32.zip \
    && wget -qO googlechromestandaloneenterprise64.msi ${DOWNLOAD_URL}/files/chrome/${CHROME_VERSION}/googlechromestandaloneenterprise64.msi \
